...
const paletteToStyle = paletteArray => {
  ...
  for (let i = 0; i < paletteArray.length; i = i + 4) {
    let percent = Math.trunc(paletteArray[i] / .255) / 10;
...
export { adjustGamma, CSSToFastLED, paletteStringToString, paletteToString, paletteToStyle, updateClipboard, paletteNameConverter };
